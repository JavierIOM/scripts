...
function Get-LatestDellCommandMonitor {
    ...
    # Dell Command | Monitor latest version
    # Note: Dell has restricted direct downloads. Use Dell Support Assist or manual download
    # Latest version: 10.12.3 (November 2025)

    Write-Log "Dell Command | Monitor must be downloaded manually from Dell Support" -Level Warning
    Write-Log "Visit: https://www.dell.com/support/home/en-us/drivers/driversdetails?driverid=904df" -Level Info
    Write-Log "Or search for 'Dell Command Monitor' in Dell Support Assist" -Level Info

    return [PSCustomObject]@{
        Version     = '10.12.3'
        DownloadUrl = 'https://www.dell.com/support/home/en-us/drivers/driversdetails?driverid=904df'
        FileName    = 'Dell-Command-Monitor_10.12.3_A00.EXE'
        FileSize    = '~60 MB'
